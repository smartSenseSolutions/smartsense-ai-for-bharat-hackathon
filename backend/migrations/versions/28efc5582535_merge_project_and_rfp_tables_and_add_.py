...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_project_vendors_id"), "project_vendors", ["id"], unique=False
    )
    ...
    # op.drop_index(op.f("ix_vendors_gstin"), table_name="vendors", if_exists=True)
    # op.drop_index(
    #     op.f("ix_vendors_headquarters_city"), table_name="vendors", if_exists=True
    # )
    # op.drop_index(
    #     op.f("ix_vendors_headquarters_state"), table_name="vendors", if_exists=True
    # )
    # op.drop_index(op.f("ix_vendors_is_active"), table_name="vendors", if_exists=True)
    # op.drop_index(op.f("ix_vendors_is_verified"), table_name="vendors", if_exists=True)
    # op.drop_index(op.f("ix_vendors_vendor_type"), table_name="vendors", if_exists=True)
...
def downgrade() -> None:
    ...
    #     "vendors",
    #     sa.Column(
    #         "headquarters_state", sa.VARCHAR(), autoincrement=False, nullable=True
    #     ),
    # )
    # op.add_column(
    #     "vendors",
    ...
    #     "vendors",
    #     sa.Column(
    #         "pan_number", sa.VARCHAR(length=10), autoincrement=False, nullable=True
    #     ),
    # )
    # op.add_column(
    #     "vendors",
    ...
    #     "vendors",
    #     sa.Column(
    #         "contact_person_name", sa.VARCHAR(), autoincrement=False, nullable=True
    #     ),
    # )
    # op.add_column(
    #     "vendors",
    #     sa.Column(
    #         "msme_udyam_number", sa.VARCHAR(), autoincrement=False, nullable=True
    #     ),
    # )
    # op.add_column(
    #     "vendors",
    ...
    #     "vendors",
    #     sa.Column(
    #         "headquarters_pincode", sa.VARCHAR(), autoincrement=False, nullable=True
    #     ),
    # )
    # op.add_column(
    #     "vendors",
    #     sa.Column("iec_code", sa.VARCHAR(), autoincrement=False, nullable=True),
    # )
    # op.add_column(
    #     "vendors",
    #     sa.Column("cin", sa.VARCHAR(length=21), autoincrement=False, nullable=True),
    # )
    # op.add_column(
    #     "vendors",
    #     sa.Column(
    ...
    #     "vendors",
    #     sa.Column(
    #         "headquarters_city", sa.VARCHAR(), autoincrement=False, nullable=True
    #     ),
    # )
    # op.add_column(
    #     "vendors",
    ...
    # )
    # op.create_index(
    #     op.f("ix_vendors_vendor_type"), "vendors", ["vendor_type"], unique=False
    # )
    # op.create_index(
    #     op.f("ix_vendors_is_verified"), "vendors", ["is_verified"], unique=False
    # )
    # op.create_index(
    #     op.f("ix_vendors_is_active"), "vendors", ["is_active"], unique=False
    # )
    # op.create_index(
    #     op.f("ix_vendors_headquarters_state"),
    #     "vendors",
    #     ["headquarters_state"],
    #     unique=False,
    # )
    # op.create_index(
    #     op.f("ix_vendors_headquarters_city"),
    #     "vendors",
    #     ["headquarters_city"],
    #     unique=False,
    # )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["project_id"], ["projects.id"], name=op.f("rfps_project_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["vendor_id"], ["vendors.id"], name=op.f("rfps_vendor_id_fkey")
        ),
